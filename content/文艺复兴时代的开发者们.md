这是亚马逊CTO Werner Vogels（沃纳·沃格尔斯）博客中的一篇文章的节选，我觉得他说的很对，程序员们，我们不应该担心着某一天丢掉工作，我们应该为身处这个变革中感到兴奋！

> 原文：https://www.allthingsdistributed.com/2025/11/tech-predictions-for-2026-and-beyond.html
...
工具在变化，但基本的原则却始终不变。随着生成式 AI 重新塑造了软件开发的模式，一种常见的观点又重新浮现出来——即开发者将会被淘汰。但如果我们从历史中吸取了任何教训，那么这就是开发者的新时代的开始，是开发者的复兴。
...
你已经听过了那些传闻。看看新闻标题吧：人工智能会让开发者变得不再重要了；现在任何人都能编写代码了。只要描述一下你想做的事情，其他的事情就由工具来处理吧。专业开发者的时代已经结束了。
...
我们已经见过这种情况了，也听说过类似的说法。早期的汇编程序员们曾经认为编译器会让他们变得多余。然而，编译器提升了抽象层次，使得软件开发变得更加普及，让更多的人能够参与到软件开发的行列中。曾经需要深厚硬件知识的工作，现在只需要逻辑和创造力就能完成。因为软件变得易于制作，于是出现了许多新的行业。企业、研究实验室和大学突然之间有了能力自己创造工具。
...
在 21 世纪初，当云计算出现时，工程技术人员也表达了类似的担忧。他们担心自动化会让他们失去工作机会。然而，实际上自动化降低了实验的门槛，从而催生了无数新的项目、新公司以及新的工程职位。这种简化带来了更大的需求。
...
每一次技术飞跃都遵循着类似的规律。工具不断进化，工作流程发生变化，复杂性也日益增加，然而那些优秀开发者的核心特质却始终保持不变。创造力、好奇心以及系统思维，这些特质一直主导着这一职业的发展。
...
我们一次又一次地看到，降低进入市场的门槛并不会消除对人类专业知识的需求，反而会加剧这种需求。生成式人工智能能够在几秒钟内生成代码，但如果你使用低质量的代码，那么最终得到的成果也会很糟糕。人工智能不会参与预算会议，不会在会议上讨论是追求成本优化还是性能优化。它不明白，客户服务系统需要拥有稳定的运行时间，而内部报告仪表盘在销售高峰期则可能需要稳定运行。当利益相关者说“要快速完成”时，它可能意味着“要以低成本完成”。那些政治因素、各种限制条件以及那些未被明确提及的优先级，都影响着每一个技术决策。这些都需要一个能够理解这些因素对支付费用的人以及实际使用该系统的人来说为何重要的开发者来处理。
...
在达·芬奇绘制《蒙娜丽莎》之前，他通过解剖尸体来了解肌肉结构，研究水流以设计运河系统，观察鸟类以想象出飞行机械。他的《维特鲁威人》不仅仅是一种艺术作品——它更是一幅关于人体比例的比例图，以及关于人类在世界中地位的哲学宣言。就像那些将艺术、科学和工程结合起来的文艺复兴时期的伟大人物一样，在这个由人工智能辅助的世界中茁壮成长的程序员们也必须成为现代的通才——即文艺复兴时期的程序员。
...
他们明白，系统是一个充满变化的动态环境，各种变化会波及到服务、API、数据库、基础设施以及人员等方面。他们以清晰的方式传达信息，让人类和机器都能从中学习。他们掌控着所创造事物的质量、安全性以及意图，尤其是在人工智能越来越能够自我纠正错误的情况下。他们还拥有一些领域知识，这些是人工智能无法替代的，比如对业务、客户以及现实世界中的各种限制条件的理解。他们永不停息地学习。
...
那些一直存在于优秀开发者身上的基本原则始终不会改变。但就像文艺复兴时期的伟大思想家们拒绝局限于某一学科领域一样，现在的开发者也不再能够孤立地工作。我们必须从更高的角度去思考问题，因为时代的要求如此。这对开发者来说是一个新的时代开端。你现在变得无比有价值，你的创造力也变得前所未有。所以，继续创造吧，保持好奇心，不断解决世界上最棘手的问题。
